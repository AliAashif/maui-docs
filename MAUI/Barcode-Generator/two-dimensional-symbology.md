...
The two-dimensional [.NET MAUI Barcode Generator](https://www.syncfusion.com/maui-controls/maui-barcodes) represents information using a two-dimensional approach. It is similar to one-dimensional barcodes, but it can represent more data per unit area. The barcode generator control supports the following two-dimensional symbology:
