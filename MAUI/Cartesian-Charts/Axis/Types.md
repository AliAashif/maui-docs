...
description: Learn here all about axis types and their features in Syncfusion® .NET MAUI Chart (SfCartesianChart) control and more.
platform: maui
...
Before initializing the chart axis, ensure that the Syncfusion.Maui.Charts package is installed and that the following namespace is imported.
...
// Initialize the series and add to the chart
...
![NumericalAxis support in .NET MAUI Chart](Axis_Images/maui_chart_axis_types.jpg)
...
![NumericalAxis interval support in .NET MAUI Chart](Axis_Images/maui_chart_numeric_axis_interval.jpg)

### Customizing the Range

[Maximum](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.NumericalAxis.html#Syncfusion_Maui_Charts_NumericalAxis_Maximum) and [Minimum](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.NumericalAxis.html#Syncfusion_Maui_Charts_NumericalAxis_Minimum) properties of axis are used for setting the maximum and minimum values of the axis range respectively.
...
![CategoryAxis support in .NET MAUI Chart](Axis_Images/maui_chart_category_axis.jpg)
...
The [LabelPlacement](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.CategoryAxis.html#Syncfusion_Maui_Charts_CategoryAxis_LabelPlacement) property in [CategoryAxis](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.CategoryAxis.html) is used to place the axis labels based on ticks and between ticks. The default value of [LabelPlacement](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.CategoryAxis.html#Syncfusion_Maui_Charts_CategoryAxis_LabelPlacement) is [OnTicks](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.LabelPlacement.html#Syncfusion_Maui_Charts_LabelPlacement_OnTicks).
...
![Axis label placement support in .NET MAUI Chart](Axis_Images/maui_chart_category_axis_labelPlacement.jpg)

### Interval

By default, the [CategoryAxis](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.CategoryAxis.html) axis labels are displayed at a fixed interval of 1. It can be customized by using the [Interval](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.CategoryAxis.html#Syncfusion_Maui_Charts_CategoryAxis_Interval) property of axis.
...
![CategoryAxis interval support in .NET MAUI Chart](Axis_Images/maui_chart_category_axis_interval.jpg)
...
![CategoryAxis ArrangeByIndex support in .NET MAUI Chart](Axis_Images/ArrangeByIndex.png)
...
![DateTimeAxis support in .NET MAUI Chart](Axis_Images/maui_chart_datetime_axis.jpg)
...
![DateTimeAxis interval support in .NET MAUI Chart](Axis_Images/maui_chart_datetime_axis_interval.jpg)
...
![DateTimeAxis range customization support in .NET MAUI Chart](Axis_Images/maui_chart_datetime_axis_range.jpg)
...
![DateTimeCategoryAxis support in .NET MAUI Chart](Axis_Images/maui_dateTimeCategory_axis.png)
...
![DateTimeCategoryAxis interval support in .NET MAUI Chart](Axis_Images/maui_dateTimeCategory_interval.png)
...
![LogarithmicAxis support in .NET MAUI Chart](Axis_Images/maui_chart_logarithmic_axis.jpg)
...
To customize the range of the log axis, you can use the [Minimum](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.LogarithmicAxis.html#Syncfusion_Maui_Charts_LogarithmicAxis_Minimum), [Maximum](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.LogarithmicAxis.html#Syncfusion_Maui_Charts_LogarithmicAxis_Maximum) properties of the [LogarithmicAxis](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.LogarithmicAxis.html). By default, an optimal range will be calculated automatically based on the provided data. 
...
![LogarithmicAxis base customization in .NET MAUI Chart](Axis_Images/maui_chart_logarithmic_axis_base.jpg)
...
![Inversed axis support in .NET MAUI Chart](Axis_Images/maui_chart_axis_isInversed.jpg)
...
![Multiple axes support in .NET MAUI Chart](Axis_Images/maui_chart_multiple_axes.png)
...
![Axis crossing support in .NET MAUI Chart](Axis_Images/maui_chart_axis_crossing.png)
...
![RenderNextToCrossingValue support in .NET MAUI Chart](Axis_Images/maui_chart_axis_rendernexttocrossingvalue.png)

### Crossing the date-time axis

For the crossing on a date-time horizontal axis, a `DateTime` object should be provided as the value for the `CrossesAt` property of the vertical axis.
...
![DateTimeAxis crossing support in .NET MAUI Chart](Axis_Images/maui_chart_datetime_axis_crossing.png)
...
![Axis opposite position in .NET MAUI Chart](Axis_Images/maui_chart_axis_opposite_position.png)
...
* [LabelStyle](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.ChartAxisLabelEventArgs.html#Syncfusion_Maui_Charts_ChartAxisLabelEventArgs_LabelStyle) - Used to customize the appearance of axis labels. For more details, refer to the [axis label customization](https://help.syncfusion.com/maui/cartesian-charts/axis-labels) topic.
